...
import { ActiveUserFullviewComponent } from './active-users-fullview.component';
...
import { CustomNumberPipe } from "../../../shared/custom-number.pipe";
...
describe('ActiveUserFullviewComponent', () => {
  let component: ActiveUserFullviewComponent;
  let fixture: ComponentFixture<ActiveUserFullviewComponent>;
  let inputEl: DebugElement;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ActiveUserFullviewComponent, LearnerPaceComponent,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActiveUserFullviewComponent);
