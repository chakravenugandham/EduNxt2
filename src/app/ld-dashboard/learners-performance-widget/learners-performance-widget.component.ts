        ...
        for (let i in this.responseData) {
          if (this.getTab == "performance") {
            ...
            this.progressDataSet.push({
              label: this.responseData[i].sectionName,
              Group1: this.responseData[i].actualProgress = this.responseData[i].actualProgress > 100 ? 100 : this.responseData[i].actualProgressprogress,
              Group2: this.responseData[i].expectedProgress = this.responseData[i].expectedProgress > 100 ? 100 : this.responseData[i].expectedProgressprogress
            });
          }
        }
      });
