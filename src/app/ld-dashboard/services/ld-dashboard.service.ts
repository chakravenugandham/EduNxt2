...
export class LdDashboardService implements OnInit {
   ...
   // program_course: string = '&programId=' + this.programObj.programId + '&courseId=' + this.programObj.courseId ;
    program_course: string = '&programId=' + this.programObj.programId + '&courseId=' + this.programObj.courseId + '&batchId=' + this.programObj.batchId + '&sectionId=' + this.programObj.sectionId;
    ...
    UserId = (this.cookieService.get('user_id') == '') ? '3212' : this.cookieService.get('user_id');
    ...
    applyDropdownButton(config?: any) {
        this.programObj.programId = config.programId;
        this.programObj.courseId = config.courseId;
        this.programObj.batchId = config.batchId;
        this.programObj.sectionId = config.sectionId;
        this.program_course = '&programId=' + this.programObj.programId + '&courseId=' + this.programObj.courseId + '&batchId=' + this.programObj.batchId + '&sectionId=' + this.programObj.sectionId;
